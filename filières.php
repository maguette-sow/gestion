...
$offset = ($page-1)*$size;
  ...
  if ($niveau=="all") {
      $requete="select * from filières
       where nomfiliere like '%$nomf%'
       limit $size 
       offset $offset";

       $requeteCount="select count(*) countF from filières
       where nomfiliere like '%$nomf%' ";
  }else{ 
      $requete="select * from filières
         where nomfiliere like '%$nomf%'
     ...
     <div class="container">
          <div class="panel panel-success margetop">
             ...
             <div class="panel-body">
               <form action="filières.php" method="get" class="form-inline">
             ...
             <div class="panel-body">
               <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                   ...
                   <?php while($filières=$resultatF->fetch()){ ?>
                     <tr>
                        <td><?php echo $filières['idfilieres'] ?></td>
                        <td><?php echo $filières['nomfiliere'] ?></td>
                        <td><?php echo $filières['niveau']     ?></td>
                        <td>
                         <a href="editerfilière.php">
                           <span class="glyphicon glyphicon-edit"></span>
                         </a>
                         &nbsp;
                         <a onclick="return confirm('Êtes vous sûr de vouloir supprimer la filière')"
                          href="supprimerfilière.php">
               ...
               <div>
                  <ul class="pagination">
                   <?php  for($i=1;$i<=$nbrPage;$i++)  { ?>
                     <li class="<?php if($i==$page) echo'active'?>"> <a href="filières.php?page=<?php echo $i; ?> ">
                             <?php echo $i; ?> 
                          </a> 
                    </li>
                   <?php }  ?>                                   
