...
alter table stagiaires ADD CONSTRAINT fk_filières_stagiaires FOREIGN key(idfilieres) REFERENCES filières(idfilieres);
ALTER TABLE `filières` CHANGE `idfilieres` `idfilieres` INT(11) NULL DEFAULT NULL AUTO_INCREMENT;


insert into filières(nomfiliere,niveau) VALUES
('ROBOTIQUE','L'),
('ROBOTIQUE','M'),
('IDA','L'),
('IDA','M'),
